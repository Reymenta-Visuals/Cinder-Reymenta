...
#pragma endregion menu
	...
	sprintf(buf, "Reymenta Fps %c %d###fps", "|/-\\"[(int)(ImGui::GetTime() / 0.25f) & 3], fps);
	ImGui::Begin(buf);
	{
		...
		ImGui::RadioButton("WS", &currentWindowRow1, 6);  ImGui::SameLine();
		ImGui::RadioButton("Render", &currentWindowRow1, 7);  ImGui::SameLine();
		// flip vertically
		int hue = 0;
		...
		ImGui::RadioButton("Console", &currentWindowRow2, 4);
