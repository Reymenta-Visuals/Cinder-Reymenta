...
#pragma endregion menu
	...
	sprintf(buf, "Reymenta Fps %c %d###fps", "|/-\\"[(int)(ui::GetTime() / 0.25f) & 3], fps);
	ui::Begin(buf);
	{
		...
		ui::RadioButton("WS", &currentWindowRow1, 6);  ui::SameLine();
		ui::RadioButton("Render", &currentWindowRow1, 7);  ui::SameLine();
		// flip vertically
		int hue = 0;
		...
		ui::RadioButton("Console", &currentWindowRow2, 4);
